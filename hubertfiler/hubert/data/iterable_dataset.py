...
from .utils import barrier, get_fs_local_rank, get_global_rank, get_world_size, roundrobin, threaded_generator
...
class IterableDataset(torch.utils.data.IterableDataset[Dict[str, Any]]):
    ...
    def _build_and_save_global_indices(self):
        ...
        if self.fs_local_rank == 0:
            print("Saving global data order indices...")
            ...
            print("Global data order indices saved to '%s'", self.global_indices_file)
        barrier()
