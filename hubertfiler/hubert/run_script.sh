...
export CHECKPOINTS_PATH=/n/netscratch/sham_lab/Everyone/cbrownpinilla/models/finetune-roberta-new
...
srun python train.py configs/base.yaml --overwrites ${OVERWRITE_CONFIG}